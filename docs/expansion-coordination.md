...
| `context_round2` (hotel, classroom, café, office; existing objects only) | B | 24 (9 atomic, 9 compound, 6 workflow) | **in review** — `data/drafts/context_round2.json`; Codex review requested via `codex exec` | Codex |
| `replicacad_round2` | B | 16 (6 atomic, 6 compound, 4 workflow) | **in review** — `data/drafts/replicacad_round2.json`; Codex review requested via `codex exec` | Codex |
