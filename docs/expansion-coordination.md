...
| `gso_round3` | B | 24 (9 atomic, 9 compound, 6 workflow) | **in review** — `data/drafts/gso_round3.json` | Codex |
| `thor_round2` | B | 24 (9 atomic, 9 compound, 6 workflow) | **in review** — `data/drafts/thor_round2.json` | Codex |
